...
---
# 团队分工
1. 李淑慧（2025303110033）[@6622339](https://github.com/6622339)：数据预处理、可视化绘图
2. 余瑞（2025303120005）[@yuyuyu93764](https://github.com/yuyuyu93764)：数据分析、甲烷排放趋势图
3. 覃紫慧（2025303120142）[@cuut123](https://github.com/cuut123)：报告撰写、相关性分析
## 📋 项目简介
